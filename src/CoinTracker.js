...
export default function CoinTracker() {
    ...
    const [ coins, setCoins ] = useState([]);   // coins라서 []배열
    const [ currentUnit, setCurrentUnit ] = useState(topCoins[0]);
    const [ value, setValue ] = useState('');   // 문자열을 담음.
                            ...
                            <div>
                                <input 
                                    ...
                                    value={ 
                                        ...
                                        (
                                            // 줄인 식 
                                            // value / coins.filter(coin => coin.symbol === currentUnit)[0].quotes.USD.price, 6

                                            // 풀어쓴 식
                                            value / coins.filter(coin => 
                                            {
                                                return coin.symbol === currentUnit
                                            })[0].quotes.USD.price, 6
                                        )
                                        : ''
                                    }
                                    */
